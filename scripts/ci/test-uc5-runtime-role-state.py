...
class FakeVault:
    def __init__(self):
        self.values = {
            ...
            MODULE.RUNTIME_POLICY: "path \"node-operator-runtime/data/validators/hoodi/hoodi-001/runtime/*\" { capabilities = [\"read\"] }",
            MODULE.DB_ROLE: {"bound_service_account_names": ["validator-slashing-db"]},
            MODULE.DB_POLICY: "path \"node-operator-runtime/data/validators/hoodi/hoodi-001/runtime/slashing-db-password\" { capabilities = [\"read\"] }",
            MODULE.CLIENT_ROLE: {"bound_service_account_names": ["validator-client"]},
            MODULE.CLIENT_POLICY: "path \"node-operator-runtime/data/validators/hoodi/hoodi-001/runtime/client-tls\" { capabilities = [\"read\"] }",
        }
        self.writes = []
