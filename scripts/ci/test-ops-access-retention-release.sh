...
jq -n '
  def rs: [
    ...
    {address:"aws_instance.host",mode:"managed",type:"aws_instance",values:{id:"i-02c57d75e7f6810b1",instance_type:"t3.micro",ebs_optimized:false,monitoring:false}},
