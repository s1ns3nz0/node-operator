...
def node(name, region="ap-northeast-2"):
    return {"metadata": {"name": name, "labels": {}}, "spec": {"providerID": f"aws:///{region}a/i-1234abcd"}, "status": {"nodeInfo": {"operatingSystem": "linux", "osImage": "Amazon Linux 2023", "architecture": "amd64"}}}
