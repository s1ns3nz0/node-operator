...
alternate_image="106760547719.dkr.ecr.ap-northeast-2.amazonaws.com/hoodi-001-baseline-validator-fence@$digest"
...
grep -Fq -- '--source-name hoodi-001-baseline-validator-fence' "$scratch/trace"
expect_fail "$collector" "106760547719.dkr.ecr.ap-northeast-2.amazonaws.com/hoodi-001-baseline-validator-prysm@$digest" "$revision" "$scratch/fail.json"
expect_fail "$collector" "106760547719.dkr.ecr.ap-northeast-2.amazonaws.com/hoodi_001-baseline-validator-fence@$digest" "$revision" "$scratch/fail.json"
: > "$scratch/trace"
