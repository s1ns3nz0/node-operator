...
jq -n --arg key "$key" '{schema_version:1,event_type:"uc-3",collected_at_utc:"2026-09-07T00:00:00Z",correlation_id:"12345678-1234-1234-1234-1234567890ab",network:"hoodi",validator_set:"hoodi-001",validator_public_key:$key,source:"private-beacon",payload:{validator_index:"123",token:"prohibited"}}' > "$tmp/forbidden.json"
