...
ALTERNATE_IMAGE = f"123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/hoodi-001-baseline-validator-fence@{DIGEST}"
...
class FenceReleaseAuthorizationTests(unittest.TestCase):
    ...
    def test_wrong_type_and_malformed_deployment_repositories_fail_closed(self) -> None:
        for image in (
            f"123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/hoodi-001-baseline-validator-prysm@{DIGEST}",
