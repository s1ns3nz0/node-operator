...
ARGS=dict(account="123456789012",region="us-west-2",deployment="other-deployment",validator_set="hoodi-001",image_ref="123456789012.dkr.ecr.us-west-2.amazonaws.com/validator-fluent-bit@sha256:"+"a"*64,logs_endpoint_ipv4s=["10.4.5.6"],kubernetes_api_service_ipv4="172.31.0.1",fluent_bit_config=CONFIG)
