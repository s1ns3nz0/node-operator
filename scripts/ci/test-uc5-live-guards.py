...
def proof():
    return {"schema_version": 1, "event_type": "signing-proxy-fence",
            ...
            "validator_set": "hoodi-001", "validator_public_key": KEY,
...
def baseline():
    return {"schema_version": 1, "validator_set": "hoodi-001", "validator_public_key": KEY,
...
def live():
    b = baseline()
    return {"schema_version": 1, "validator_set": "hoodi-001",
...
def test_positive_guard_emits_only_sanitized_identity_and_hashes():
    ...
    assert result["validator_set"] == "hoodi-001"
