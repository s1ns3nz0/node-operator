...
IDENTITY = {"validator_set":"hoodi-001", "validator_public_key":"0x" + "a" * 96, "validator_index":"123", "deployment_name":"node-operator", "release_revision":"b" * 40, "activation_slot":"300"}
