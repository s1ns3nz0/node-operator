...
D='a'*64; DISC={'aws_account_id':'106760547719','aws_region':'us-east-1','deployment_name':'node-op-2609140157'}
def ref(name,d=D):return f"106760547719.dkr.ecr.us-east-1.amazonaws.com/node-op-2609140157-{name}@sha256:{d}"
class T(unittest.TestCase):
 def call(self,receipt,manifest,capability=None):
  with tempfile.TemporaryDirectory() as directory:
   t=Path(directory); f=t/'f';b=t/'b';o=t/'o';f.write_text(json.dumps({'hoodi_nat_public_ip':'198.51.100.42'}));b.write_text(json.dumps({'ebs_kms_key_arn':{'value':'arn:aws:kms:us-east-1:106760547719:key/11111111-2222-3333-4444-555555555555'}}))
