...
path_is_in_release_boundary() {
  case "$1" in
    docs/gitops/vault-tls-internal-ca.example.yaml)
      return 0
      ;;
    scripts/release/installer_state.py|scripts/release/installer_preflight.py|scripts/release/installer_bundle.py|scripts/release/installer_infrastructure.py|scripts/release/installer_ops_access.py|scripts/release/installer_ops_execution.py|scripts/release/installer_ops_verify.py|scripts/release/installer_vault_inputs.py|scripts/release/installer_vault_plan.py|scripts/release/installer_vault_workspace.py|scripts/release/installer_vault_execution.py|scripts/release/installer_vault_authority.py|scripts/release/installer_vault_platform.py|scripts/release/installer_vault_receipt.py|scripts/release/installer_artifact_mirror.py|scripts/release/installer_files.py|scripts/release/interactive_deploy.py|scripts/release/render-private-cert-manager-values.py|scripts/release/create-installer-artifact-index.py)
      return 0
      ;;
...
materialize_source_file() {
  ...
  case "$relative_path" in
    scripts/release/*.sh|scripts/release/render-private-cert-manager-values.py|scripts/release/create-installer-artifact-index.py|scripts/ops/*|scripts/ci/check-ops-access-ssm-retention-plan.sh) chmod 0755 "$stage_directory/source/$relative_path" ;;
  esac
}
