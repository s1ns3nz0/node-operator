...
class VerifyTests(unittest.TestCase):
    def setUp(self):
        ...
        self.write(self.state / "private-eks-session.json", {"schema_version": 1, "aws_region": "ap-northeast-1", "cluster_name": "test-node", "ssm_ops_instance_id": "i-0123abcd"})
    ...
    def aws(self, profile, region, args):
        ...
        if args[0] == "ssm": return {"InstanceInformationList": [{"InstanceId": "i-0123abcd", "PingStatus": "Online", "PlatformType": "Linux", "ResourceType": "EC2Instance"}]}
        if args[0] == "ec2": return {"Reservations": [{"Instances": [{"InstanceId": "i-0123abcd", "State": {"Name": "running"}, "VpcId": "vpc-abc", "SubnetId": "subnet-abc"}]}]}
    ...
    def test_offline_or_public_instance_never_starts_wrapper(self):
        def offline(*args): return {"InstanceInformationList": [{"InstanceId": "i-0123abcd", "PingStatus": "Offline", "PlatformType": "Linux", "ResourceType": "EC2Instance"}]} if args[2][0] == "ssm" else self.aws(*args)
    ...
    def test_bad_handoff_and_bad_namespace_are_rejected(self):
        self.write(self.state / "private-eks-session.json", {"schema_version": True, "aws_region": "ap-northeast-1", "cluster_name": "test-node", "ssm_ops_instance_id": "i-0123abcd"})
