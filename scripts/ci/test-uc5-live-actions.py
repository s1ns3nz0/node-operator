...
def runner_factory(control):
    ...
    def run(args):
        key = tuple(args)
        named = {("statefulset", "validator-hoodi-001-client"): controller("statefulset", "validator-hoodi-001-client", "client-uid", control.replicas["client"]), ("deployment", "validator-hoodi-001-signing-fence"): controller("deployment", "validator-hoodi-001-signing-fence", "fence-uid", control.replicas["fence"]), ("deployment", "validator-hoodi-001-remote-signer"): controller("deployment", "validator-hoodi-001-remote-signer", "signer-uid", control.replicas["signer"], True), ("statefulset", "validator-hoodi-001-slashing-db"): controller("statefulset", "validator-hoodi-001-slashing-db", "db-uid", 1)}
