...
def fixtures():
    ...
    values = {
        ("-n", MODULE.NAMESPACE, "get", "statefulset", "validator-hoodi-001-client", "-o", "json"): controller("client-uid", 0, "client"),
        ("-n", MODULE.NAMESPACE, "get", "deployment", "validator-hoodi-001-signing-fence", "-o", "json"): controller("fence-uid", 0, "fence"),
        ("-n", MODULE.NAMESPACE, "get", "deployment", "validator-hoodi-001-remote-signer", "-o", "json"): controller("signer-uid", 0, "signer", image),
        ("-n", MODULE.NAMESPACE, "get", "statefulset", "validator-hoodi-001-slashing-db", "-o", "json"): controller("db-uid", 1, "db"),
...
def test_exact_schemas_are_collected_from_only_fixed_reads():
    ...
    proof = {"schema_version": 1, "event_type": "signing-proxy-fence", "collected_at_utc": "2026-09-11T00:00:00Z",
             "network": "hoodi", "validator_set": "hoodi-001", "validator_public_key": KEY, "source": "signing-proxy-fence",
    ...
    assert GUARDS.verify_predelete(proof, baseline, live, 1_789_084_800)["validator_set"] == "hoodi-001"
...
def test_additive_policies_endpoint_slices_and_argo_are_conservative():
    ...
    values, calls = fixtures(), []
    signer = values[("-n", MODULE.NAMESPACE, "get", "deployment", "validator-hoodi-001-remote-signer", "-o", "json")]
