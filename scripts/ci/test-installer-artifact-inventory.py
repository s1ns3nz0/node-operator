...
class ArtifactInventoryTests(unittest.TestCase):
    ...
    def test_client_chart_authorization_selects_destination_and_orphans_reject(self):
        ...
        statement={"_type":"https://in-toto.io/Statement/v1","subject":[{"name":"106760547719.dkr.ecr.ap-northeast-2.amazonaws.com/node-operator-baseline-gitops-client/node-operator-client","digest":{"sha256":digest[7:]}}],"predicateType":"https://slsa.dev/provenance/v1","predicate":predicate}
        ...
        image=f"106760547719.dkr.ecr.ap-northeast-2.amazonaws.com/node-operator-baseline-gitops-client/node-operator-client@{digest}"
