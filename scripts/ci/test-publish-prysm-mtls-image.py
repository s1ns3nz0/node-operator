...
class TestPublisher(unittest.TestCase):
    def setUp(self):
        ...
        for relative in ("scripts/release/publish-prysm-mtls-image.sh", "scripts/release/prysm_publication_record.py", "scripts/ci/scan-release-sbom.sh", "scripts/ci/verify-release-scan-attestation.sh", "scripts/ci/lib/common.sh"):
