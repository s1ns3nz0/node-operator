...
class FetchRecords(unittest.TestCase):
    ...
    def test_accepts_deployment_scoped_relay_repository_record(self):
        relay = record("vault-audit-relay", "relay-publish", "cosign-and-slsa", f"123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/node-op-2609140157-baseline-vault-audit-relay@{DIGEST}")
