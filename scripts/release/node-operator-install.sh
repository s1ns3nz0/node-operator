#!/usr/bin/env bash
# Purpose: Enter guarded discovery, infrastructure execution and separate SSM input preparation.
...
# Side effects: Local writes and AWS reads; --apply-infrastructure provisions only after terminal confirmation.
set -euo pipefail
