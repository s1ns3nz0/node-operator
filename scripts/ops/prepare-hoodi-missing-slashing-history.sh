...
usage() { printf '%s\n' "Usage: ${0##*/} --validator-set hoodi-001 --validator-public-key <0x-key> --exception-approval-id <id> --output-dir <absolute-dir> --execute" >&2; exit "${1:-64}"; }
