...
SET = "hoodi-001"
CONTROLLERS = {
    "client": ("statefulset", "validator-hoodi-001-client"),
    "fence": ("deployment", "validator-hoodi-001-signing-fence"),
    "signer": ("deployment", "validator-hoodi-001-remote-signer"),
    "db": ("statefulset", "validator-hoodi-001-slashing-db"),
}
PVC = "data-validator-hoodi-001-slashing-db-0"
LEASE = "validator-hoodi-001-primary"
PUBLIC_SERVICE = "validator-hoodi-001-remote-signer"
DIRECT_SERVICE = "validator-hoodi-001-remote-signer-direct"
SIGNER_POLICY = "validator-hoodi-001-signer-ingress"
