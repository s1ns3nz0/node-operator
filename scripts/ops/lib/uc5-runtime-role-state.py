...
``auth/kubernetes/role/hoodi-hoodi-001-runtime``.  Captured data contains the
...
RUNTIME_ROLE = "auth/kubernetes/role/hoodi-hoodi-001-runtime"
RUNTIME_POLICY = "sys/policies/acl/hoodi-hoodi-001-runtime"
DB_ROLE = "auth/kubernetes/role/hoodi-hoodi-001-slashing-db"
DB_POLICY = "sys/policies/acl/hoodi-hoodi-001-slashing-db"
CLIENT_ROLE = "auth/kubernetes/role/hoodi-hoodi-001-client-tls"
CLIENT_POLICY = "sys/policies/acl/hoodi-hoodi-001-client-tls"
...
REQUIRED_ROLE = {
    ...
    "audience": "vault",
    "token_policies": ["hoodi-hoodi-001-runtime"],
    "token_ttl": 300,
    "token_max_ttl": 600,
