...
def main():
    ...
    parser.add_argument("--validator-set", choices=("hoodi-001",), default="hoodi-001")
        ...
        if args.mode == "prepare-activation":
            ...
            try:
                ...
                if ownership == "owned" and collection_complete:
                    ...
                    print("INCOMPLETE: uc5-hoodi-001-maintenance marker retained; ceremony_id=" + control.ceremony_id + "; inspect owned diagnostic Pods and continuity failure before recovery. No activation performed.", file=sys.stderr)
