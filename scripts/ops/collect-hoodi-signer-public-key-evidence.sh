...
probe_image='106760547719.dkr.ecr.ap-northeast-2.amazonaws.com/node-operator-baseline-validator-signer-identity-probe@sha256:11212189c98afaeb719eaaa8ac7d3c86179884c84986c97c9c1a35b6b4f4ec8f'
...
jq --arg image "$probe_image" '.spec.containers[0].image = $image' "$manifest" > "$manifest.tmp"
