...
registry=106760547719.dkr.ecr.ap-northeast-2.amazonaws.com
...
test "$(aws sts get-caller-identity --query Arn --output text)" = arn:aws:iam::106760547719:user/jsyang
