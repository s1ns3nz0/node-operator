# Always-on Argo CD and client execution plan

1. Inspect live prerequisites, private runner contracts, workload manifests, and GitHub repository boundaries.
2. Create a private GitOps source that contains only reviewed, non-secret deployment inputs.
3. Reconcile the system node pool to one node and install Argo CD from the approved private bootstrap path.
