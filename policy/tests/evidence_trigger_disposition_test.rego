...
gate_trigger_exception := {"rule":"workflow.unsafe","check_id":"dangerous-triggers","subject":".github/workflows/opa-pr-gate.yml","owner":"fjybjinsu","rationale":"reviewed trust boundary","issue":"docs/security/workflow-trigger-exception.md#ci-evidence-gate","expires_at":"2026-10-03T00:00:00Z"}

test_gate_trigger_disposition_is_exact if {
  fixture := {"policy":{"exceptions":[gate_trigger_exception]}}
  decision.exception_applies("workflow.unsafe", ".github/workflows/opa-pr-gate.yml", "dangerous-triggers") with input as fixture
  not decision.exception_applies("workflow.unsafe", ".github/workflows/other.yml", "dangerous-triggers") with input as fixture
  not decision.exception_applies("workflow.unsafe", ".github/workflows/opa-pr-gate.yml", "untrusted-zizmor-suppression") with input as fixture
  not decision.exception_applies("iac.checkov", ".github/workflows/opa-pr-gate.yml", "dangerous-triggers") with input as fixture
}
...
test_gate_trigger_expired_or_malformed_disposition_blocks if {
  every expiry in ["2020-01-01T00:00:00Z", "invalid", null] {
    ...
    not decision.exception_applies("workflow.unsafe", ".github/workflows/opa-pr-gate.yml", "dangerous-triggers") with input as fixture
  }
}
